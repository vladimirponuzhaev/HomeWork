...
if (DayOfWeek == 6)
{
    WriteLine("Введённая цифра, обозначаюет выходной день недели - субботу!");
}

if (DayOfWeek == 7)
{
    WriteLine("Введённая цифра, обозначаюет выходной день недели - воскресенье!");
}